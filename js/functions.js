	...
	if (iconMenu) {
		iconMenu.addEventListener("click", function (e) {
			if (iconMenu) {
				...
				if (document.documentElement.classList.contains('catalog-open')) {//checks catalog
					document.documentElement.classList.remove('catalog-open');//remove catalog
				}
				if (document.documentElement.classList.contains('sub-menu-open')) { //checks catalog
					document.documentElement.classList.remove('sub-menu-open');// remove
				}
			}
		});
	};
